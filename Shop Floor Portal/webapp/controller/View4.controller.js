...
// 	return Controller.extend("Shop_floor_portalShop_floor_portal.controller.View4", {


// 	onInit: function() {
// 		var url1 = "/sap/opu/odata/sap/ZODATA_TH_SFP_PROD_ORDERS_SRV/";
// 			var result1;
// 			var od1 = new sap.ui.model.odata.ODataModel(url1,true);
// 			od1.read("ZODATA_TH_SFP_PROD_ORDERSSet?$filter=OrderNum eq '0001'",{
// 				context:null,
// 				urlParameter:null,
// 				async:false,
...
sap.ui.define([
	...
	return Controller.extend("Shop_floor_portalShop_floor_portal.controller.View4", {	
		onSubmit    : function()
		{
			var url = "/sap/opu/odata/sap/ZODATA_TH_SFP_PROD_ORDERS_SRV/";
			...
			od.read("ZODATA_TH_SFP_PROD_ORDERSSet?$filter=OrderNum eq '0001'",{
				context:null,
				urlParameter:null,
				async:false,
				success: function(oData, oResponse)
